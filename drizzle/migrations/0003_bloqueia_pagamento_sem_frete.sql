...
BEGIN
  ...
  IF p_estado = 'confirmado'
     AND v_metodo = 'entrega'
     AND COALESCE(v_pedido.frete_status,'pendente') <> 'definido' THEN
    RAISE EXCEPTION 'Defina o frete antes de confirmar o pagamento.' USING ERRCODE = '23514';
  END IF;
