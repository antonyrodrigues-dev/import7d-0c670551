...
export const PRODUCTS: Product[] = [
  {
    ...
    name: "Polo Piquet Marfim",
    description:
      "Polo masculina em algodão piquet de alta gramatura. Gola estruturada, abotoamento em madrepérola, corte regular.",
    category: "Polos",
    price: 690,
    sizes: ["P", "M", "G", "GG"],
    image: m1a.url,
  ...
  },
  {
    ...
    description:
      "Oxford italiano em fio 80. Colarinho semi-italiano, punho duplo, costura francesa interna.",
    category: "Camisas",
    price: 890,
    sizes: ["P", "M", "G", "GG"],
    image: m2a.url,
  ...
  {
    slug: "jaqueta-couro-conhaque",
    name: "Jaqueta Couro Conhaque",
    description:
      "Couro bovino curtido vegetal em conhaque. Forro em algodão, zíper metálico antique, gola ribana.",
    category: "Jaquetas",
    price: 3290,
    sizes: ["P", "M", "G", "GG"],
    image: m3a.url,
  ...
  },
  {
    ...
    name: "Polo Oliva Tipped",
    description:
      "Polo em algodão pima oliva com detalhe contrastante na gola. Caimento ajustado, acabamento sartorial.",
    category: "Polos",
    price: 720,
    sizes: ["P", "M", "G", "GG"],
    image: m4a.url,
  ...
  {
    slug: "camisa-linho-marfim",
    name: "Camisa Linho Marfim",
    description:
      "Linho belga em marfim. Caimento solto, mangas longas com punho simples, botões em corozo natural.",
    category: "Camisas",
    price: 980,
    sizes: ["P", "M", "G", "GG"],
    image: m5a.url,
  ...
  },
  {
    ...
    name: "Bomber Ônix",
    description:
      "Bomber em nylon técnico preto. Gola e punhos em ribana, zíper duplo, bolsos embutidos.",
    category: "Jaquetas",
    price: 1490,
    sizes: ["P", "M", "G", "GG"],
    image: m6a.url,
